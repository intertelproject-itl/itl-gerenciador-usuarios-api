...
WORKDIR /src
COPY ["itl-gerenciador-usuarios-api/itl-gerenciador-usuarios-api.csproj", "itl-gerenciador-usuarios-api/"]
RUN dotnet restore "./itl-gerenciador-usuarios-api/itl-gerenciador-usuarios-api.csproj"
COPY . .
